...
export function ButtonLink({
  ...
  return (
    <PrismicNextLink
      className={clsx(
        styles.buttonCutout,
        "group mx-4 inline-flex items-center bg-gradient-to-b from-25% to-75% bg-[length:100%_400%] font-bold transition-[filter,background-position] duration-300 hover:bg-bottom",
